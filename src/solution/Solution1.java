...
public class Solution1 {
    public void show1() {
        System.out.println("Solution 1 : show 1");
        Cat cat = CatSingleton1.instance(null).getCat();
        System.out.println(cat);
    }

    public void show2() {
        List<String> tmp = Arrays.asList("z", "a", "q");
        ListSingleton.instance(tmp);
        System.out.println("Solution 1 : show 2");
        List<String> list = ListSingleton.instance(null).getList();
        System.out.println(Arrays.toString(list.toArray()));
    }

    public void show3() {
        System.out.println("Solution 1 : show 3");
